...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Register New Manager</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
            <form action="#" class="form formManager">
                                    ...
                                    <div class="card-body">
                                        <div class="card card-primary p-3">
                                            <div class="card-header">
                                                <h3 class="card-title text-light">Manager Details</h3>
                                            </div>
                                            <div class="row pt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="manager_id" name='manager_id' class="form-control" placeholder="Manager Id  ">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name='mobile' id="mobile" class="form-control" placeholder="Manager Mobile Number  ">
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="manager_type">Branch</label>
                                                        <select class="custom-select rounded-0" id="manager_type">
                                        ...
                                        <div class="card card-primary p-3">
                                            <div class="card-header">
                                                <h3 class="card-title text-light">Manager Login Details</h3>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-group">
                                                        <label>Manager User Name</label>
                                                        <input type="text" name='userName' id="uname" class="form-control" placeholder="Manager User Name  ">
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" id="password" name='password' class="form-control" placeholder="Manager Password  ">
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="submit" class="form-control btn btn-success" value="Save Manager" />
                                                </div>
                                            </div>
                                            <div class="col-md-4"></div>
                                        </div>
    ...
    <script src="validateManager.js"></script>
