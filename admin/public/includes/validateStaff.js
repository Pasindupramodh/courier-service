const schema = joi.object({
    staff_id: joi.string().min(3).max(30).label("Staff ID").required(),
...
$(document).ready(function () {
    $(".formStaff").on("submit", function (e) {
        e.preventDefault();
        const form = this;
        const staffIdField = $(form).find("#staff_id");
        ...
        if (isValid) {
            ...
            var e = document.getElementById("staff_type");
            ...
            var f = new FormData();
            f.append("staffId", staff_id.value);
            ...
            r.open("POST", "saveStaffProcess.php", true);
            r.send(f);
