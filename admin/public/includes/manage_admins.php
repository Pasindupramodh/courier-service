                                        ...
                                        <div class="table-responsive">
                                            <table id="example1" class="table table-bordered table-striped table-text table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $result = $employee->getAllAdmins(1);
                                                    if ($result) {
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" id="id" name='id' class="form-control" placeholder="Admin ID ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name='mobile' id="mobile" class="form-control" placeholder="Admin Mobile Number  ">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer form-group">
                        <input type="submit" class="form-control btn btn-success" value="Update Admin" />
                    </div>
