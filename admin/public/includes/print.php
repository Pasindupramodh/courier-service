...
<body class="A5">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-header">
                        ...
                        <img src="../images/icons/logo.png" height="50" width="50"/> Hopit Express
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <th>Total:</th>
                                <td><?php 
                                if(clear($row['courier_type'])=="Cash"){
                                    echo "0";
                                }else{
                                    echo clear($row['charge']);
                                } ?></td>
                            </tr>
                            <tr>
    ...
    <script type="text/javascript" src="../plugins/jsbarcode/jsBarcode.js"></script>
    <script>
