...
<body class="hold-transition sidebar-mini">
                                                                ...
                                                                if ($lastStatus["status"] == "Pending") {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a class='btn  bg-success btn-sm  '
                                                                                href="print.php?p_id= <?= $row['courier_id'] ?> ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($result) {
                                                            foreach ($result as $row) {
                                                                ...
                                                                if ($lastStatus["status"] != "Pending" && $lastStatus["status"] != "Finished" && $lastStatus["status"] != "Returned") {
                                                                    ?>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo clear($row["barcode_no"]); ?>
    ...
    <script>
        ...
        $('#senderDetails').on('show.bs.modal', function (event) {
            ...
            r.open("POST", "getSender.php", true);
            r.send(f);
        ...
        $('#receiverDetails').on('show.bs.modal', function (event) {
            ...
            r.open("POST", "getReceiver.php", true);
            r.send(f);
