    ...
    (e = {
          ...
          v = {
            Base: class {
              ...
              alter(e) {
                ...
                for (const r in e) {
                  ...
                  s(
                    ...
                    t.$_terms.alterations.push({ target: r, adjuster: n });
                }
                return (t.$_temp.ruleset = !1), t;
              }
              artifact(e) {
                return (
                  s(void 0 !== e, "Artifact cannot be undefined"),
                  s(!this._cache, "Cannot set an artifact with a rule cache"),
                  this.$_setFlag("artifact", e)
                );
              }
              cast(e) {
                return (
                  s(!1 === e || "string" == typeof e, "Invalid to value"),
                  s(
              ...
              external(e, t) {
                return (
                  "object" == typeof e &&
                    (s(!t, "Cannot combine options with description"),
                    (t = e.description),
                    (e = e.method)),
                  s("function" == typeof e, "Method must be a function"),
                  s(
              ...
              id(e) {
                return e
                  ? (s("string" == typeof e, "id must be a non-empty string"),
                    s(/^[^\.]+$/.test(e), "id cannot contain period character"),
                    this.$_setFlag("id", e))
              ...
              meta(e) {
                return (
                  s(void 0 !== e, "Meta cannot be undefined"),
              ...
              only() {
                let e =
                  ...
                  arguments[0];
                return (
                  s("boolean" == typeof e, "Invalid mode:", e),
              ...
              prefs(e) {
                s(e, "Missing preferences"),
                  s(void 0 === e.context, "Cannot override context"),
                  s(void 0 === e.externals, "Cannot override externals"),
                  s(void 0 === e.warnings, "Cannot override warnings"),
                  s(void 0 === e.debug, "Cannot override debug"),
              ...
              result(e) {
                return (
                  s(["raw", "strip"].includes(e), "Unknown result mode", e),
              ...
              valid() {
                ...
                return s.$_setFlag("only", !!s._valids, { clone: !1 }), s;
              }
              when(e, t) {
                const r = this.clone();
              ...
              cache(e) {
                s(!this._inRuleset(), "Cannot set caching inside a ruleset"),
                  s(!this._cache, "Cannot override schema cache"),
                  s(
                ...
                const t = this.clone();
                return (
                  (t._cache = e || o.provider.provision()),
                  (t.$_temp.ruleset = !1),
                  t
                );
              }
              ...
              concat(e) {
                s(l.isSchema(e), "Invalid schema object"),
                  s(
                    "any" === this.type ||
                      "any" === e.type ||
                      e.type === this.type,
                ...
                for (const r in e.$_terms) {
                  ...
                  s
                    ? t.$_terms[r]
                      ? (t.$_terms[r] = t.$_terms[r].concat(s))
                      : (t.$_terms[r] = s.slice())
                    : t.$_terms[r] || (t.$_terms[r] = s);
                }
                return (
                  this.$_root._tracer &&
              ...
              extend(e) {
                return (
                  s(!e.base, "Cannot extend type with another base"),
                  f.type(this, e)
                );
              }
              extract(e) {
                return (
                  (e = Array.isArray(e) ? e : e.split(".")), this._ids.reach(e)
                );
              }
              fork(e, t) {
              ...
              rule(e) {
                ...
                for (let i = r; i < a._rules.length; ++i) {
                  ...
                  for (const n in e)
                    t.modifiers[n](o, e[n]),
                      s(o.name === r.name, "Cannot change rule name");
                  (a._rules[i] = o),
                    a._singleRules.get(o.name) === r &&
                      a._singleRules.set(o.name, o);
                }
              ...
              tailor(e) {
                (e = [].concat(e)),
                  s(!this._inRuleset(), "Cannot tailor inside a ruleset");
                let t = this;
                if (this.$_terms.alterations)
                  for (const { target: r, adjuster: n } of this.$_terms
                    .alterations)
                    e.includes(r) &&
                      ((t = n(t)),
                      s(
              ...
              $_addRule(e) {
                "string" == typeof e && (e = { name: e }),
                  s(e && "object" == typeof e, "Invalid options"),
                  s(e.name && "string" == typeof e.name, "Invalid rule name");
                for (const t in e)
                  s("_" !== t[0], "Cannot set private rule properties");
                ...
                if (n) {
                  ...
                  for (const e in n) {
                    ...
                    if (r.argsByName) {
                      ...
                      if (o.ref && l.isResolvable(i))
                        t._resolve.push(e), a.$_mutateRegister(i);
                      else if (
                        (o.normalize && ((i = o.normalize(i)), (n[e] = i)),
                        o.assert)
                      ) {
                ...
                return (
                  r.multi ||
                    (a._ruleRemove(t.name, { clone: !1 }),
                    a._singleRules.set(t.name, t)),
                  !1 === a.$_temp.ruleset && (a.$_temp.ruleset = null),
                  r.priority ? a._rules.unshift(t) : a._rules.push(t),
                  a
                );
              }
              $_compile(e, t) {
              ...
              $_createError(e, t, r, s, n) {
                ...
                const i = !1 !== a.flags ? this._flags : {},
                  o = a.messages
                    ? m.merge(this._definition.messages, a.messages)
              ...
              $_mapLabels(e) {
                return (
                  (e = Array.isArray(e) ? e : e.split(".")), this._ids.labels(e)
                );
              }
              $_match(e, t, r, s) {
                ...
                return (
                  ...
                  this.$_modify({
                    each: (e, t) => {
                      ...
                      const i =
                        this._definition[r][s] &&
                        this._definition[r][s].register;
                      !1 !== i &&
                        this.$_mutateRegister(e, { family: i, key: a });
                    },
                  }),
              ...
              $_setFlag(e, t) {
                ...
                if ((a(t, n.default) && (t = void 0), a(t, this._flags[e])))
                  return this;
              ...
              _assign(e) {
                (e.type = this.type),
                  ...
                  (e._singleRules = n(this._singleRules, { shallow: !0 })),
              ...
              _generate(e, t, r) {
                ...
                for (let a = 0; a < this.$_terms.whens.length; ++a) {
                  ...
                  for (let c = 0; c < l.length; ++c) {
                    const { is: u, then: f, otherwise: h } = l[c],
                      m = `${a}${i.switch ? "." + c : ""}`;
                    if (u.$_match(o, t.nest(u, `${m}.is`), r)) {
                      if (f) {
                        const a = t.localize(
                          ...
                          { schema: i, id: o } = f._generate(e, a, r);
                      ...
                      const a = t.localize(
                        ...
                        { schema: i, id: o } = h._generate(e, a, r);
                ...
                const a = n.join(", ");
                if ((t.mainstay.tracer.debug(t, "rule", "when", a), !a))
                  return { schema: this };
                if (!t.mainstay.tracer.active && this.$_temp.whens[a])
                  return { schema: this.$_temp.whens[a], id: a };
                let i = this;
                ...
                return (
                  this.$_root._tracer &&
                    this.$_root._tracer._combine(i, [this, ...s]),
              ...
              _inner(e, t) {
                ...
                const n = this.clone();
                return (
                  (n.$_terms[e] && !r.override) || (n.$_terms[e] = []),
                  r.single ? n.$_terms[e].push(t) : n.$_terms[e].push(...t),
                  (n.$_temp.ruleset = !1),
                  n
                );
              }
              _inRuleset() {
                return (
                  null !== this.$_temp.ruleset && !1 !== this.$_temp.ruleset
                );
              }
              _ruleRemove(e) {
                let t =
              ...
              _values(e, t) {
                ...
                if (
                  ...
                  !r[t] && e.length
                    ? (r[t] = new b())
                    : n &&
                      ((r[t] = e.length ? new b() : null), r.$_mutateRebuild()),
                  !r[t])
                )
                  return r;
                n && r[t].override();
        ...
        (t.version = a.version),
          ...
          (t.preferences = function (e, s) {
            ...
            return (
              s.errors &&
                e.errors &&
                ((n.errors = Object.assign({}, e.errors, s.errors)),
                (n.errors.wrap = Object.assign(
                  {},
                  e.errors.wrap,
                  s.errors.wrap
                ))),
              s.messages && (n.messages = i.compile(s.messages, e.messages)),
      ...
      3292: (e, t, r) => {
        ...
        (t.schema = function (e, t) {
          ...
          (i.schema = function (e, t, r) {
            s(void 0 !== t, "Invalid undefined schema"),
              Array.isArray(t) &&
                (s(t.length, "Invalid empty array schema"),
                1 === t.length && (t = t[0]));
            const a = function (t) {
              for (
            ...
            if (
              (s("object" == typeof t, "Invalid schema content:", typeof t),
              n.isResolvable(t))
            )
              return a(e, t);
          ...
          (i.simple = function (e) {
            return (
              null === e || ["boolean", "string", "number"].includes(typeof e)
            );
          }),
          (t.when = function (e, r, o) {
            if (
              (void 0 === o &&
                (s(r && "object" == typeof r, "Missing options"),
                (o = r),
                (r = a.create("."))),
            ...
            if (
              (s(a.isRef(r) || "string" == typeof r, "Invalid condition:", r),
              s(
                void 0 === o.not || void 0 === o.is,
            ...
            s(Array.isArray(o.switch), '"switch" must be an array'),
              s(void 0 === o.is, 'Cannot combine "switch" with "is"'),
              s(void 0 === o.not, 'Cannot combine "switch" with "not"'),
              s(void 0 === o.then, 'Cannot combine "switch" with "then"');
            const l = { ref: t.ref(r), switch: [], break: o.break };
            for (let t = 0; t < o.switch.length; ++t) {
              ...
              n.assertOptions(
                ...
                s(void 0 !== r.is, 'Switch statement missing "is"'),
                s(void 0 !== r.then, 'Switch statement missing "then"');
              const c = { is: e.$_compile(r.is), then: e.$_compile(r.then) };
              if (
                (a.isRef(r.is) || n.isSchema(r.is) || (c.is = c.is.required()),
                i)
              ) {
                s(
      ...
      6354: (e, t, r) => {
        ...
        (t.Report = class {
          ...
          _setTemplate(e) {
            if (
              ((this.template = e), !this.flags.label && 0 === this.path.length)
            ) {
          ...
          (t.label = function (e, r, s, n) {
            ...
            return (
              t.path(a) ||
              t.template(null, s.messages, "root", r, s) ||
              (n && t.template(null, n, "root", r, s)) ||
              "value"
            );
          }),
          ...
          (t.ValidationError.prototype.annotate = s.error);
      },
      8901: (e, t, r) => {
        "use strict";
        const s = r(375),
        ...
        (t.type = function (e, t) {
          ...
          (u.terms = h),
            ...
            (u.prepare = o.prepare(u.prepare, f.prepare)),
            u.coerce &&
            ...
            (u.coerce = o.coerce(u.coerce, f.coerce)),
            (u.validate = o.validate(u.validate, f.validate));
          ...
          if (u.rules)
            for (const e in u.rules) {
              ...
              if (
                ...
                r && (s(!l[e], "Rule conflict in", u.type, e), (l[e] = r)),
                s(!m[e], "Rule conflict in", u.type, e),
                (m[e] = t),
                t.alias)
              ) {
          ...
          if (((u.modifiers = d), u.overrides)) {
            ...
            for (const e in u.overrides)
              s(r[e], "Cannot override missing", e),
                (u.overrides[e][a.symbols.parent] = r[e]),
          ...
          return (
            ...
            (u.manifest = p),
            (u.rebuild = o.rebuild(u.rebuild, f.rebuild)),
            c
          );
        }),
            ...
            return e && t
              ? function (r, s) {
                  ...
                  if (n) {
                    if (
                      n.errors &&
                      (!Array.isArray(n.errors) || n.errors.length)
                    )
                      return n;
                    r = n.value;
                  }
      ...
      5107: (e, t, r) => {
        ...
        (p.methods = {
          ...
          assert(e, t) {
            for (
              var r = arguments.length, s = new Array(r > 2 ? r - 2 : 0), n = 2;
              n < r;
              n++
            )
              s[n - 2] = arguments[n];
          ...
          defaults(e) {
            ...
            for (const r of t._types) {
              const n = e(t[r]());
              s(i.isSchema(n), "modifier must return a valid schema object"),
                (t[r] = function () {
                  for (
                    var e = arguments.length, t = new Array(e), r = 0;
                    r < e;
          ...
          extend() {
            ...
            i.verifyFlat(t, "extend"),
              (d = d || r(3378)),
              s(t.length, "You need to provide at least one extension"),
              this.assert(t, d.extensions);
            ...
            for (let e of t) {
              ...
              for (const e of t) {
                s(
                  void 0 === a[e.type] || a._types.has(e.type),
          ...
          (p.assert = function (e, t, r, s) {
            const a =
                s[0] instanceof Error || "string" == typeof s[0] ? s[0] : null,
              o = null !== a ? s[1] : s[0],
              c = t.validate(
                e,
                i.preferences({ errors: { stack: !0 } }, o || {})
              );
            let u = c.error;
            if (!u) return c.value;
            if (a instanceof Error) throw a;
            const f =
              r && "function" == typeof u.annotate ? u.annotate() : u.message;
            throw (
              (u instanceof l.ValidationError == 0 && (u = n(u)),
              (u.message = a ? `${a} ${f}` : f),
              u)
            );
          }),
          (p.generate = function (e, t, r) {
            return (
              s(e, "Must be invoked on a Joi instance."),
              (t.$_root = e),
      ...
      6914: (e, t, r) => {
        ...
        (t.compile = function (e, t) {
          if ("string" == typeof e)
            return s(!t, "Cannot set single message string"), new a(e);
          if (a.isTemplate(e))
            return s(!t, "Cannot set single message template"), e;
          s(
          ...
          for (let r in e) {
            ...
            for (r in ((t[i] = t[i] || {}), n)) {
              const e = n[r];
              "root" === r || a.isTemplate(e)
                ? (t[i][r] = e)
                : (s("string" == typeof e, "Invalid message for", r, "in", i),
                  (t[i][r] = new a(e)));
            }
          }
          return t;
          ...
          (t.merge = function (e, r) {
            ...
            for (let e in r) {
              ...
              for (e in ((i[n] = i[n] || {}), t)) {
                const r = t[e];
                "root" === e || a.isTemplate(r)
                  ? (i[n][e] = r)
                  : (s("string" == typeof r, "Invalid message for", e, "in", n),
                    (i[n][e] = new a(r)));
              }
            }
            return i;
        ...
        (t.Ids = i.Ids =
          class {
            ...
            fork(e, t, r) {
              ...
              a.push({ schema: r });
              const o = a.shift();
              let l = { id: o.id, schema: t(o.schema) };
              s(
                n.isSchema(l.schema),
                "adjuster function failed to return a joi schema type"
              );
              for (const e of a)
                l = { id: e.id, schema: i.fork(e.schema, l.id, l.schema) };
              return l.schema;
            }
            labels(e) {
              let t =
            ...
            register(e) {
              ...
              t &&
                (s(!this._byKey.has(t), "Schema already contains key:", t),
                s(
                  !this._byId.has(t),
                  "Schema key conflicts with existing id:",
                  t
          ...
          (t.schema = function (e, t) {
            ...
            for (const s in e._flags) {
              if ("_" === s[0]) continue;
              const n = i.scan(e._flags[s], { source: "flags", name: s }, t);
              void 0 !== n && ((r = r || e.clone()), (r._flags[s] = n));
            }
            for (let s = 0; s < e._rules.length; ++s) {
              const n = e._rules[s],
                a = i.scan(n.args, { source: "rules", name: n.name }, t);
              if (void 0 !== a) {
                r = r || e.clone();
                const t = Object.assign({}, n);
                (t.args = a),
                  (r._rules[s] = t),
                  r._singleRules.get(n.name) === n &&
                    r._singleRules.set(n.name, t);
              }
            }
            for (const s in e.$_terms) {
              if ("_" === s[0]) continue;
              const n = i.scan(e.$_terms[s], { source: "terms", name: s }, t);
          ...
          (i.scan = function (e, t, r, s, o) {
            ...
            if (
              (!1 !== r.schema && n.isSchema(e)) ||
              (!1 !== r.ref && a.isRef(e))
            ) {
              const s = r.each(e, { ...t, path: l, key: o });
              if (s === e) return;
              return s;
            }
            for (const s in e) {
      ...
      6133: (e, t, r) => {
        ...
        (t.create = function (e) {
          ...
          s("string" == typeof e, "Invalid reference key:", e),
            i.assertOptions(t, [
              "adjust",
              "ancestor",
              "in",
          ...
          return (
            (r.path = n ? (null === e ? [] : e.split(n)) : [e]), new l.Ref(r)
          );
        }),
          (t.in = function (e) {
            let r =
          ...
          (l.Ref = class {
            constructor(e) {
              s("object" == typeof e, "Invalid reference construction"),
                i.assertOptions(e, [
                  "adjust",
                  "ancestor",
                  "in",
            ...
            resolve(e, t, r, n) {
              let a =
                arguments.length > 4 && void 0 !== arguments[4]
                  ...
                  : {};
              return (
                s(!this.in || a.in, "Invalid in() reference usage"),
                "global" === this.type
                  ? this._resolve(r.context, t, a)
                  : "local" === this.type
                  ? this._resolve(n, t, a)
                  : this.ancestor
                  ? "root" === this.ancestor
                    ? this._resolve(t.ancestors[t.ancestors.length - 1], t, a)
                    : (s(
                        this.ancestor <= t.ancestors.length,
                        "Invalid reference exceeds the schema root:",
                        this.display
                      ),
                      this._resolve(t.ancestors[this.ancestor - 1], t, a))
                  : this._resolve(e, t, a)
              );
            }
            _resolve(e, t, r) {
          ...
          (l.context = function (e, t) {
            ...
            if (((e = e.trim()), r)) {
              ...
              if (s !== t && e.startsWith(s))
                return { key: e.slice(s.length), type: "global" };
              const n = void 0 === r.local ? "#" : r.local;
              if (n !== t && e.startsWith(n))
                return { key: e.slice(n.length), type: "local" };
              const a = void 0 === r.root ? "/" : r.root;
              if (a !== t && e.startsWith(a))
                return { key: e.slice(a.length), type: "value", root: !0 };
            }
              ...
              if (e)
                if (((s = void 0 === s ? t.toParent : s), Array.isArray(e)))
                  ...
                  t.isRef(e) &&
                    "value" === e.type &&
                    e.ancestor - s >= 0 &&
                    this.refs.push({ ancestor: e.ancestor - s, root: e.root }),
                    (o = o || r(3328)),
                    o.isTemplate(e) && this.register(e.refs(), s);
            }
            get length() {
      ...
      3378: (e, t, r) => {
        ...
        const s = r(5107),
          n = {};
        (n.wrap = s.string().min(1).max(2).allow(!1)),
          (t.preferences = s
            .object({
              ...
              errors: {
                ...
                render: s.boolean(),
                stack: s.boolean(),
                wrap: { label: n.wrap, array: n.wrap, string: n.wrap },
              },
              externals: s.boolean(),
              messages: s.object(),
              ...
              stripUnknown: s
                .object({ arrays: s.boolean(), objects: s.boolean() })
                .or("arrays", "objects")
                .allow(!0, !1),
              warnings: s.boolean(),
            })
              ...
              .items(
                ...
                s.object({
                  ...
                  assert: s
                    ...
                    .conditional("ref", { is: !0, then: s.required() }),
                  normalize: s.function(),
                  message: s
                    .string()
                    .when("assert", { is: s.function(), then: s.required() }),
                })
              ),
            convert: s.boolean(),
            manifest: s.boolean(),
          ...
          (t.extension = s
            .object({
              ...
              base: s
                .object()
                .schema()
                .when("type", { is: s.object().regex(), then: s.forbidden() }),
              coerce: [
              ...
              flags: s
                ...
                .pattern(
                  n.nameRx,
                  s.object({ setter: s.string(), default: s.any() })
                ),
              manifest: { build: s.function().arity(2) },
              messages: [s.object(), s.string()],
              modifiers: s
                .object()
                .pattern(n.nameRx, s.function().minArity(1).maxArity(2)),
          ...
          (t.extensions = s
            .array()
            .items(s.object(), s.function().arity(1))
            .strict()),
          (n.desc = {
            ...
            .object({
              ...
              preferences: {
                ...
                errors: {
                  ...
                  wrap: { label: n.wrap, array: n.wrap },
                },
                externals: s.boolean(),
        ...
        (e.exports = i.State =
          class {
            ...
            localize(e) {
              ...
              return (
                r && s.schemas && (s.schemas = [i.schemas(r), ...s.schemas]), s
              );
            }
            nest(e, t) {
              const r = new i.State(this.path, this.ancestors, this);
              return (
                (r.schemas = r.schemas && [i.schemas(e), ...r.schemas]),
                (r.debug = t),
                r
              );
            }
            shadow(e, t) {
              (this.mainstay.shadow = this.mainstay.shadow || new i.Shadow()),
                this.mainstay.shadow.set(this.path, e, t);
            }
            snapshot() {
              this.mainstay.shadow &&
                (this._snapshot = s(this.mainstay.shadow.node(this.path))),
          ...
          (i.Shadow = class {
            ...
            override(e, t) {
              ...
              const r = e.slice(0, -1),
                s = e[e.length - 1],
                a = n(this._values, r, { iterables: !0 });
      ...
      3328: (e, t, r) => {
        ...
        (e.exports = u.Template =
          class {
            constructor(e, t) {
              s("string" == typeof e, "Template source must be a string"),
                s(
            ...
            _parse() {
              ...
              for (const e of t) {
                ...
                const o = ":" === i[0];
                o && (i = i.slice(1));
                const l = this._ref(u.decode(i), { raw: t, wrapped: o });
            ...
            resolve(e, t, r, s) {
              return this._template && 1 === this._template.length
                ? this._part(this._template[0], e, t, r, s, {})
                : this.render(e, t, r, s);
            }
            _part(e) {
              for (
            ...
            render(e, t, r, s) {
              ...
              for (const o of this._template)
                if ("string" == typeof o) i.push(o);
                  ...
                  if (void 0 !== c) {
                    const e =
                      o.raw || !1 === (n.errors && n.errors.escapeHtml)
                        ? c
                        : a(c);
          ...
          (u.stringify = function (e, t, r, s, n) {
            ...
            if (
              (c.isRef(e) &&
                e.render &&
                ((l = e.in), (e = e.resolve(t, r, s, n, { in: e.in, ...a }))),
              null === e)
            )
              return "null";
            ...
            if (e instanceof Map) {
              ...
              for (const [r, s] of e.entries())
                t.push(`${r.toString()} -> ${s.toString()}`);
              e = t;
            }
            if (!Array.isArray(e)) return e.toString();
            const f = [];
            for (const i of e)
              f.push(u.stringify(i, t, r, s, n, { arrayItems: !0, ...a }));
          ...
          (u.functions = {
            ...
            msg(e) {
              ...
              if (!i) return "";
              const o =
                l.template(t, i[0], e, r, s) || l.template(t, i[1], e, r, s);
        ...
        (e.exports = a.extend({
          ...
          validate(e, t) {
            ...
            if (r._flags.match) {
              ...
              return c(r)
                ? { value: t.reduce((e, t) => n(e, t, { mergeArrays: !1 })) }
                : { value: t[t.length - 1] };
            }
            const o = [];
            for (let t = 0; t < r.$_terms.matches.length; ++t) {
              ...
              if (s.schema) {
                ...
                r.restore(), o.push({ schema: s.schema, reports: n.errors });
                continue;
              }
          ...
          rules: {
            conditional: {
              method(e, t) {
                s(!this._flags._endedSwitch, "Unreachable condition"),
                  s(
                    !this._flags.match,
            ...
            try: {
              method() {
                for (
                  ...
                  t[r] = arguments[r];
                s(t.length, "Missing alternative schemas"),
                  i.verifyFlat(t, "try"),
                  s(!this._flags._endedSwitch, "Unreachable condition");
                const n = this.clone();
                for (const e of t)
                  n.$_terms.matches.push({ schema: n.$_compile(e) });
              ...
              if (t.matches)
                for (const r of t.matches) {
                  ...
                  e = t
                    ...
                    : e.conditional(n, { then: i, otherwise: o });
                }
              return e;
            },
          },
          ...
          (u.errors = function (e, t) {
            ...
            for (const { reports: t, schema: i } of e) {
              ...
              "base" === f ? n.add(c) : a.push({ type: i.type, report: o });
            }
            return a.length
              ? 1 === a.length
                ? { errors: a[0].report }
                : u.unmatched(e, r)
              : { errors: r("alternatives.types", { types: [...n] }) };
          }),
          (u.unmatched = function (e, t) {
            const r = [];
            for (const t of e) r.push(...t.reports);
            return {
              errors: t("alternatives.match", l.details(r, { override: !1 })),
            };
          });
      },
      8068: (e, t, r) => {
        ...
        e.exports = n.extend({
          ...
          rules: {
            ...
            warning: {
              method(e, t) {
                return (
                  s(e && "string" == typeof e, "Invalid warning code"),
                  this.$_addRule({
                    name: "warning",
                    args: { code: e, local: t },
                    warn: !0,
          ...
          manifest: {
            build(e, t) {
              for (const r in t) {
                const s = t[r];
                if (
                  ["examples", "externals", "metas", "notes", "tags"].includes(
                    r
                  )
                )
                  ...
                  if ("whens" !== r) {
                    ...
                    for (const t of s) {
                      ...
                      e = o
                        ...
                        : e.when(s, { then: a, otherwise: i, break: t.break });
                    }
                else {
                  const t = {};
          ...
          rules: {
            has: {
              ...
              validate(e, t, r) {
                ...
                return l
                  ? a("array.hasKnown", { patternLabel: l })
            ...
            items: {
              ...
              validate(e, t) {
                ...
                for (let t = 0; t < d; ++t) {
                  ...
                  if (!r._flags.sparse && void 0 === i) {
                    if (
                      (m.push(
                        s(
                          "array.sparse",
                          { key: g, path: y, pos: t, value: void 0 },
                          n.localize(y)
                        )
                      ),
                      a.abortEarly)
                  ...
                  for (const u of f) {
                    ...
                    if (-1 !== h) f = v[h];
                      ...
                      if (
                        (l.snapshot(), (f = u.$_validate(i, l, a)), !f.errors)
                      ) {
                  ...
                  if (
                    !o &&
                    (r.$_terms._inclusions.length ||
                      r.$_terms._requireds.length) &&
                    !p
                  ) {
                    if (w) {
                      c.fastSplice(e, t), --t, --d;
                    ...
                    if (
                      (m.push(
                        s("array.includes", { pos: t, value: i }, n.localize(y))
                      ),
                      a.abortEarly)
                    )
                      return m;
                ...
                return (
                  l.length && c.fillMissedErrors(r, m, l, e, n, a),
                  u.length &&
                    (c.fillOrderedErrors(r, m, u, e, n, a),
                    m.length || c.fillDefault(u, e, n, a)),
                  m.length ? m : e
                );
              },
              priority: !0,
            ...
            length: {
              ...
              validate(e, t, r, s) {
                let { limit: n } = r,
                  { name: a, operator: i, args: l } = s;
                return o.compare(e.length, n, i)
                  ? e
                  : t.error("array." + a, { limit: l.limit, value: e });
              },
              args: [
                {
                  name: "limit",
            ...
            ordered: {
              method() {
                ...
                for (let e = 0; e < t.length; ++e) {
                  ...
                  c.validateSingle(r, s),
                    s.$_mutateRegister(r),
                    s.$_terms.ordered.push(r);
                }
                return s.$_mutateRebuild();
              },
            },
              ...
              method() {
                ...
                return (
                  e.by &&
                    ...
                    s(!t.by.ancestor, "Cannot sort by ancestor")),
                  this.$_addRule({ name: "sort", args: { options: t } })
                );
              },
              validate(e, t, r) {
                let { error: s, state: n, prefs: a, schema: i } = t,
                  { options: o } = r;
            ...
            unique: {
              ...
              validate(e, t, r, i) {
                let { state: o, error: l, schema: c } = t,
                  { comparator: u, options: f } = r,
                  { comparator: h, path: m } = i;
                const d = {
          ...
          (c.sort = function (e, t, r, s, n) {
            const a = "ascending" === r.order ? 1 : -1,
              ...
              l = (l, u) => {
                ...
                if (
                  (r.by &&
                    ((l = r.by.resolve(l, s, n)), (u = r.by.resolve(u, s, n))),
                  (f = c.compare(l, u, i, o)),
                  null !== f)
                )
                  return f;
      ...
      4937: (e, t, r) => {
        ...
        e.exports = n.extend({
          ...
          validate(e, t) {
            let { error: r } = t;
            if ("boolean" != typeof e)
              return { value: e, errors: r("boolean.base") };
          },
          rules: {
            truthy: {
              method() {
                ...
                for (let e = 0; e < t.length; ++e) {
                  const r = t[e];
                  s(void 0 !== r, "Cannot call truthy with undefined"),
                    n.$_terms.truthy.add(r);
                }
                return n;
              },
            },
            falsy: {
              method() {
                ...
                for (let e = 0; e < t.length; ++e) {
                  const r = t[e];
                  s(void 0 !== r, "Cannot call falsy with undefined"),
                    n.$_terms.falsy.add(r);
                }
                return n;
              },
            },
          ...
          cast: {
            number: { from: o.isBool, to: (e, t) => (e ? 1 : 0) },
        ...
        (e.exports = n.extend({
          ...
          validate(e, t) {
            ...
            return n.convert && a && "string" == typeof e
              ? { value: e, errors: s("date.format", { format: a }) }
              : { value: e, errors: s("date.base") };
          },
          rules: {
            compare: {
              method: !1,
              validate(e, t, r, s) {
                let { date: n } = r,
                  { name: i, operator: o, args: l } = s;
                const c = "now" === n ? Date.now() : n.getTime();
                return a.compare(e.getTime(), c, o)
                  ? e
          ...
          (o.parse = function (e, t) {
            ...
            if ("iso" === t)
              return a.isIsoDate(e) ? o.date(e.toString()) : null;
            const r = e;
            if (
              ("string" == typeof e &&
                /^[+-]?\d+(\.\d+)?$/.test(e) &&
        ...
        e.exports = n.extend({
          ...
          rules: {
            arity: {
              ...
              validate(e, t, r) {
                let { n: s } = r;
                return e.length === s ? e : t.error("function.arity", { n: s });
              },
            },
            class: {
              method() {
      ...
      7824: (e, t, r) => {
        ...
        const s = r(978),
          ...
          f = r(6133),
          h = r(3328),
          m = { renameDefaults: { alias: !1, multiple: !1, override: !1 } };
        (e.exports = o.extend({
          type: "_keys",
          ...
          validate(e, t) {
            ...
            if (!e || typeof e !== r.$_property("typeof") || Array.isArray(e))
              return {
                value: e,
                errors: s("object.base", { type: r.$_property("typeof") }),
              };
            if (
              !(
                r.$_terms.renames ||
            ...
            e = m.clone(e, a);
            const i = [];
            if (r.$_terms.renames && !m.rename(r, e, n, a, i))
            ...
            if (r.$_terms.keys) {
              ...
              for (const s of r.$_terms.keys) {
                ...
                if (u.errors) {
                  if (a.abortEarly) return { value: e, errors: u.errors };
                  void 0 !== u.value && (e[r] = u.value), i.push(...u.errors);
                } else
                  "strip" === s.schema._flags.result ||
                  (void 0 === u.value && void 0 !== l)
                    ? delete e[r]
                    : void 0 !== u.value && (e[r] = u.value);
              }
            }
            ...
            if (r.$_terms.dependencies)
              for (const t of r.$_terms.dependencies) {
                if (
                  null !== t.key &&
                  !1 ===
                    m.isPresent(t.options)(
                      t.key.resolve(e, n, a, null, { shadow: !1 })
                    )
                )
                  continue;
                ...
                if (s) {
                  ...
                  if (a.abortEarly) return { value: e, errors: t };
                  i.push(t);
                }
              }
            return { value: e, errors: i };
          ...
          rules: {
            and: {
              method() {
                for (
                  ...
                  t[r] = arguments[r];
                return (
                  l.verifyFlat(t, "and"), m.dependency(this, "and", null, t)
                );
              },
            },
            append: {
            ...
            assert: {
              ...
              validate(e, t, r) {
                let { error: s, prefs: n, state: a } = t,
                  { subject: i, schema: o, message: l } = r;
                const c = i.resolve(e, a, n),
                  u = f.isRef(i) ? i.absolute(a) : [];
                return o.$_match(c, a.localize(u, [e, ...a.ancestors], o), n)
                  ? e
                  : s("object.assert", { subject: i, message: l });
              },
            ...
            instance: {
              method(e, t) {
                return (
                  n("function" == typeof e, "constructor must be a function"),
                  (t = t || e.name),
                  this.$_addRule({
                    name: "instance",
            ...
            length: {
              ...
              validate(e, t, r, s) {
                let { limit: n } = r,
                  { name: a, operator: i, args: o } = s;
                return l.compare(Object.keys(e).length, n, i)
                  ? e
                  : t.error("object." + a, { limit: o.limit, value: e });
              },
              args: [
                {
                  name: "limit",
            ...
            nand: {
              method() {
                for (
                  ...
                  t[r] = arguments[r];
                return (
                  l.verifyFlat(t, "nand"), m.dependency(this, "nand", null, t)
                );
              },
            },
            or: {
            ...
            pattern: {
              method(e, t) {
                ...
                s || (e = this.$_compile(e, { appendPath: !0 })),
                ...
                const i = { [s ? "regex" : "schema"]: e, rule: t };
                return (
                  r.matches &&
                    ((i.matches = this.$_compile(r.matches)),
                    "array" !== i.matches.type &&
                      (i.matches = i.matches.$_root.array().items(i.matches)),
                    a.$_mutateRegister(i.matches),
                    a.$_setFlag("_hasPatternMatch", !0, { clone: !1 })),
                  r.fallthrough && (i.fallthrough = !0),
                  a.$_terms.patterns.push(i),
                  a.$_mutateRegister(t),
                  a
                );
              },
            ...
            rename: {
              method(e, t) {
                ...
                for (const t of a.$_terms.renames)
                  n(t.from !== e, "Cannot rename the same key multiple times");
                return (
                  t instanceof h && a.$_mutateRegister(t),
                  a.$_terms.renames.push({
                    from: e,
                    to: t,
            ...
            schema: {
              ...
              validate(e, t, r) {
                let { type: s } = r;
                return !l.isSchema(e) || ("any" !== s && e.type !== s)
                  ? t.error("object.schema", { type: s })
                  : e;
              },
            },
            unknown: {
            ...
            xor: {
              method() {
                for (
                  ...
                  t[r] = arguments[r];
                return (
                  l.verifyFlat(t, "xor"), m.dependency(this, "xor", null, t)
                );
              },
            },
          },
            ...
            build(e, t) {
              ...
              if (t.patterns)
                for (const {
                  ...
                  e = e.pattern(r || s, n, { fallthrough: a, matches: i });
              if (t.renames)
                for (const { from: r, to: s, options: n } of t.renames)
                  e = e.rename(r, s, n);
              return e;
            },
          },
          ...
          (m.dependency = function (e, t, r, s, a) {
            n(null === r || "string" == typeof r, t, "key must be a strings"),
              a ||
                (a =
                  s.length > 1 && "object" == typeof s[s.length - 1]
                    ? s.pop()
                    : {}),
              l.assertOptions(a, ["separator", "isPresent"]),
              (s = [].concat(s));
            const i = l.default(a.separator, "."),
              o = [];
            for (const e of s)
              n("string" == typeof e, t, "peers must be strings"),
                o.push(c.ref(e, { separator: i, ancestor: 0, prefix: !1 }));
            null !== r &&
              (r = c.ref(r, { separator: i, ancestor: 0, prefix: !1 }));
            const u = e.clone();
            return (
              (u.$_terms.dependencies = u.$_terms.dependencies || []),
              u.$_terms.dependencies.push(new m.Dependency(t, r, o, s, a)),
              u
            );
          }),
          (m.dependencies = {
            and(e, t, r, s, n) {
              ...
              for (const e of t.peers)
                !1 === l(e.resolve(r, s, n, null, { shadow: !1 }))
                  ? a.push(e.key)
                  : i.push(e.key);
              if (a.length !== o && i.length !== o)
                return {
                  code: "object.and",
                  context: {
                    present: i,
            ...
            nand(e, t, r, s, n) {
              ...
              for (const e of t.peers)
                i(e.resolve(r, s, n, null, { shadow: !1 })) && a.push(e.key);
            ...
            or(e, t, r, s, n) {
              ...
              for (const e of t.peers)
                if (a(e.resolve(r, s, n, null, { shadow: !1 }))) return;
              return {
                code: "object.missing",
                context: {
                  peers: t.paths,
            ...
            oxor(e, t, r, s, n) {
              ...
              return (
                (o.present = a),
                (o.presentWithLabels = m.keysToLabels(e, a)),
            ...
            with(e, t, r, s, n) {
              ...
              for (const i of t.peers)
                if (!1 === a(i.resolve(r, s, n, null, { shadow: !1 })))
                  return {
                    code: "object.with",
                    context: {
                      main: t.key.key,
            ...
            without(e, t, r, s, n) {
              const a = m.isPresent(t.options);
              for (const i of t.peers)
                if (a(i.resolve(r, s, n, null, { shadow: !1 })))
                  return {
                    code: "object.without",
                    context: {
                      main: t.key.key,
            ...
            for (const i of e.$_terms.renames) {
              ...
              if (l)
                for (const e in t) {
                  ...
                  r && o.push({ from: e, to: i.to, match: r });
                }
              else
              ...
              for (const c of o) {
                ...
                let u = c.to;
                if (
                  (u instanceof h && (u = u.render(t, r, s, c.match)), o !== u)
                ) {
                  if (
                    !i.options.multiple &&
                    a[u] &&
          ...
          (m.unknown = function (e, t, r, s, n, a) {
              ...
              for (const i of r) {
                ...
                for (let f = 0; f < e.$_terms.patterns.length; ++f) {
                  ...
                  if (h.regex) {
                    ...
                    !h.schema.$_match(i, n.nest(h.schema, `pattern.${f}`), a)
                  )
                    continue;
                  r.delete(i);
                  const m = n.localize(u, l, { schema: h.rule, key: i }),
                    d = h.rule.$_validate(c, m, a);
                  if (d.errors) {
                    if (a.abortEarly) return { value: t, errors: d.errors };
                    s.push(...d.errors);
                  }
                  if (
                    (h.matches && o[f].push(i),
                    (t[i] = d.value),
                    !h.fallthrough)
                  )
                    break;
              ...
              if (i)
                for (let r = 0; r < o.length; ++r) {
                  ...
                  if (h.errors) {
                    ...
                    if (a.abortEarly) return { value: t, errors: o };
                    s.push(o);
                  }
                }
            }
            if (r.size && (e.$_terms.keys || e.$_terms.patterns)) {
              if ((a.stripUnknown && !e._flags.unknown) || a.skipFunctions) {
                const e = !(
                  !a.stripUnknown ||
                  (!0 !== a.stripUnknown && !a.stripUnknown.objects)
                );
                for (const s of r)
                  e
                    ? (delete t[s], r.delete(s))
                    : "function" == typeof t[s] && r.delete(s);
              }
            ...
            concat(e) {
              ...
              for (const s of e) {
                const e = s.key,
                  n = r.get(e);
                void 0 !== n
                  ? (t[n] = { key: e, schema: t[n].schema.concat(s.schema) })
                  : t.push(s);
              }
              return t;
            }
      ...
      8785: (e, t, r) => {
        ...
        (e.exports = n.extend({
          ...
          rules: {
            ref: {
              method(e) {
                s(!this.$_terms.link, "Cannot reinitialize schema"),
                  (e = i.ref(e)),
                  s(
          ...
          overrides: {
            concat(e) {
              s(this.$_terms.link, "Uninitialized link schema"),
                s(a.isSchema(e), "Invalid schema object"),
                s(
                  "link" !== e.type,
          ...
          manifest: {
            build: (e, t) => (
              s(t.link, "Invalid link description missing link"), e.ref(t.link)
            ),
          },
        })),
          (l.generate = function (e, t, r, s) {
            ...
            const a = e.$_terms.link[0].ref,
              { perspective: i, path: o } = l.perspective(a, r);
            ...
            return (
              l.assert("link" !== n.type, "which is another link", a, e, r, s),
              e._flags.relative || r.mainstay.links.set(e, n),
              n._generate(t, r, s).schema
            );
          }),
          (l.perspective = function (e, t) {
            if ("local" === e.type) {
              for (const { schema: r, key: s } of t.schemas) {
                if ((r._flags.id || s) === e.path[0])
            ...
            return "root" === e.ancestor
              ...
              : {
                  perspective:
                    t.schemas[e.ancestor] && t.schemas[e.ancestor].schema,
                  path: e.path,
                };
          }),
          (l.assert = function (e, t, r, n, a, i) {
            e ||
              s(
                !1,
                `"${o.label(n._flags, a, i)}" contains link reference "${
                  r.display
                }" ${t}`
              );
          });
      ...
      3832: (e, t, r) => {
        ...
        (e.exports = n.extend({
              ...
              if ((0 === n.value && (n.value = 0), !r._flags.unsafe))
                if (e.match(/e/i)) {
                  if (
                    ...
                    return (n.errors = s("number.unsafe")), n;
                } else {
          ...
          validate(e, t) {
            ...
            if (!a.isNumber(e)) return { value: e, errors: s("number.base") };
            const i = { value: e };
            if (n.convert) {
          ...
          rules: {
            compare: {
              ...
              validate(e, t, r, s) {
                let { limit: n } = r,
                  { name: i, operator: o, args: l } = s;
                return a.compare(e, n, o)
                  ? e
                  : t.error("number." + i, { limit: l.limit, value: e });
              },
              args: [
                {
                  name: "limit",
            ...
            precision: {
              method(e) {
                return (
                  s(Number.isSafeInteger(e), "limit must be an integer"),
              ...
              validate(e, t, r) {
                ...
                return Math.max(
                  ...
                  ? e
                  : t.error("number.precision", { limit: s, value: e });
              },
              convert: !0,
            },
            sign: {
              method(e) {
                return (
                  s(["negative", "positive"].includes(e), "Invalid sign", e),
                  this.$_addRule({ name: "sign", args: { sign: e } })
                );
              },
              validate(e, t, r) {
                let { sign: s } = r;
                return ("negative" === s && e < 0) ||
                  ("positive" === s && e > 0)
                  ? e
                  : t.error(`number.${s}`);
              },
            ...
            unsafe: {
              method() {
                let e =
                  ...
                  arguments[0];
                return (
                  s("boolean" == typeof e, "enabled must be a boolean"),
        ...
        (e.exports = u.extend({
          ...
          coerce: {
            ...
            method(e, t) {
              ...
              if (
                (o && o.args.enabled && (e = e.trim()), r.$_terms.replacements)
              )
                for (const t of r.$_terms.replacements)
          ...
          validate(e, t) {
            let { schema: r, error: s } = t;
            if ("string" != typeof e)
              return { value: e, errors: s("string.base") };
            if ("" === e) {
              const t = r.$_getRule("min");
              if (t && 0 === t.args.limit) return;
              return { value: e, errors: s("string.empty") };
            }
          },
          rules: {
            alphanum: {
            ...
            base64: {
              method() {
                ...
                return (
                  ...
                  s("boolean" == typeof e.urlSafe, "urlSafe must be boolean"),
                  this.$_addRule({ name: "base64", args: { options: e } })
                );
              },
              validate(e, t, r) {
                let { options: s } = r;
                return h.base64Regex[s.paddingRequired][s.urlSafe].test(e)
                  ? e
            ...
            case: {
              method(e) {
                return (
                  s(["lower", "upper"].includes(e), "Invalid case:", e),
                  this.$_addRule({ name: "case", args: { direction: e } })
                );
              },
              validate(e, t, r) {
                let { direction: s } = r;
                return ("lower" === s && e === e.toLocaleLowerCase()) ||
                  ("upper" === s && e === e.toLocaleUpperCase())
                  ? e
                  : t.error(`string.${s}case`);
              },
              convert: !0,
            },
            creditCard: {
            ...
            dataUri: {
              ...
              validate(e, t, r) {
                ...
                if (n) {
                  ...
                  if (h.base64Regex[s.paddingRequired].false.test(n[3]))
                    return e;
                }
            ...
            guid: {
              ...
              validate(e, t, r, s) {
                ...
                const a = n.exec(e);
                return a
                  ? h.guidBrackets[a[1]] !== a[a.length - 1]
                    ? t.error("string.guid")
                    : e
                  : t.error("string.guid");
              },
            ...
            hostname: {
              ...
              validate: (e, t) =>
                n.isValid(e, { minDomainSegments: 1 }) || h.ipRegex.test(e)
                  ? e
            ...
            ip: {
              method() {
                ...
                const { cidr: t, versions: r, regex: s } = i.regex(e),
                  n = e.version ? r : void 0;
                return this.$_addRule({
                  name: "ip",
                  args: { options: { cidr: t, version: n } },
                  regex: s,
                });
              },
              validate(e, t, r, s) {
                ...
                return a.test(e)
                  ...
                  : t.error("string.ip", { value: e, cidr: n.cidr });
              },
            },
            isoDate: {
              method() {
            ...
            length: {
              ...
              validate(e, t, r, s) {
                let { limit: n, encoding: a } = r,
                  { name: i, operator: o, args: l } = s;
                const c = !a && e.length;
                return f.compare(c, n, o)
                  ? e
                  : t.error("string." + i, {
                      limit: l.limit,
                      value: e,
            ...
            normalize: {
              ...
              validate(e, t, r) {
                let { error: s } = t,
                  { form: n } = r;
                return e === e.normalize(n)
                  ? e
                  : s("string.normalize", { value: e, form: n });
              },
              convert: !0,
            },
            pattern: {
              ...
              method(e) {
                let t =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : {};
                s(e instanceof RegExp, "regex must be a RegExp"),
                  s(
                    !e.flags.includes("g") && !e.flags.includes("y"),
              ...
              validate(e, t, r, s) {
                let { regex: n, options: a } = r,
                  { errorCode: i } = s;
                return n.test(e) ^ a.invert
                  ? e
                  : t.error(i, { name: a.name, regex: n, value: e });
              },
              args: ["regex", "options"],
              multi: !0,
            },
            replace: {
              method(e, t) {
                "string" == typeof e && (e = new RegExp(o(e), "g")),
                  s(e instanceof RegExp, "pattern must be a RegExp"),
                  s("string" == typeof t, "replacement must be a String");
                const r = this.clone();
                return (
            ...
            uri: {
              ...
              validate(e, t, r, s) {
                let { options: a } = r,
                  { regex: i, domain: o, scheme: l } = s;
                if (["http:/", "https:/"].includes(e))
                  return t.error("string.uri");
                const c = i.exec(e);
                if (c) {
                  const r = c[1] || c[2];
                  return !o || (a.allowRelative && !r) || n.isValid(r, o)
                    ? e
                    : t.error("string.domain", { value: r });
                }
                return a.relativeOnly
          ...
          manifest: {
            build(e, t) {
              if (t.replacements)
                for (const { pattern: r, replacement: s } of t.replacements)
                  e = e.replace(r, s);
              return e;
            },
          },
          ...
          (h.addressOptions = function (e) {
            ...
            if (!0 === e.tlds || void 0 === e.tlds)
              return (
                s(h.tlds, "Built-in TLD list disabled"),
                Object.assign({}, e, h.tlds)
              );
            s(
          ...
          (h.validateTlds = function (e, t) {
            for (const r of e)
              s(
                n.isValid(r, { minDomainSegments: 1, maxDomainSegments: 1 }),
          ...
          (h.length = function (e, t, r, n, a) {
            return (
              s(!a || !1, "Invalid encoding:", a),
              e.$_addRule({
                name: t,
                method: "length",
                args: { limit: r, encoding: a },
                operator: n,
              })
            );
          });
        ...
        (a.Map = class extends Map {
          ...
          (e.exports = n.extend({
              ...
              method(e, t) {
                ...
                return (
                  ...
                  r._flags.only && "symbol" != typeof e
                    ? {
                        value: e,
                        errors: s("symbol.map", { map: r.$_terms.map }),
                      }
                    : { value: e }
                );
              },
            ...
            validate(e, t) {
              let { error: r } = t;
              if ("symbol" != typeof e)
                return { value: e, errors: r("symbol.base") };
            },
            rules: {
              map: {
                method(e) {
                  ...
                  for (const n of e) {
                    ...
                    s(
                      ...
                      s("symbol" == typeof a, "Value must be a Symbol"),
                      t.$_terms.map.set(e, a),
                      r.push(a);
                  }
                  return t.valid(...r);
                },
      ...
      8863: (e, t, r) => {
        ...
        (t.entry = function (e, t, r) {
          ...
          r &&
            ...
            (n = o.preferences(o.defaults, r)));
          const a = u.entry(e, t, n);
          s(
            !a.mainstay.externals.length,
            "Schema with external rules must use validateAsync()"
          );
          const i = { value: a.value };
          return (
            a.error && (i.error = a.error),
            a.mainstay.warnings.length &&
              (i.warning = l.details(a.mainstay.warnings)),
            a.mainstay.debug && (i.debug = a.mainstay.debug),
            a.mainstay.artifacts && (i.artifacts = a.mainstay.artifacts),
            i
          );
        }),
          (t.entryAsync = async function (e, t, r) {
            ...
            if (a.externals.length) {
              ...
              for (const n of a.externals) {
                const f = n.state.path,
                  h = "link" === n.schema.type ? a.links.get(n.schema) : null;
                let m,
                  d,
                  p = t;
                const g = f.length ? [t] : [],
                ...
                try {
                  const e = (e, t) =>
                      (h || n.schema).$_createError(e, p, t, n.state, s),
                    i = await n.method(p, {
                      schema: n.schema,
                      linked: h,
                      state: n.state,
                  ...
                  d
                    ? (a.tracer.value(n.state, "rule", p, i, "external"),
                      (d[m] = i))
                    : (a.tracer.value(n.state, "rule", t, i, "external"),
                      (t = i));
                } catch (e) {
                  throw (s.errors.label && (e.message += ` (${n.label})`), e);
                }
              }
              if (((n.value = t), c.length))
                throw (
                  ((n.error = l.process(c, e, s)),
                  a.debug && (n.error.debug = a.debug),
                  n.error)
                );
            }
            ...
            return (
              a.warnings.length && (c.warning = l.details(a.warnings)),
              a.debug && (c.debug = a.debug),
              a.artifacts && (c.artifacts = a.artifacts),
              c
            );
          }),
          (u.Mainstay = class {
          ...
          (u.entry = function (e, r, s) {
            const { tracer: n, cleanup: a } = u.tracer(r, s),
              i = s.debug ? [] : null,
              o = r._ids._schemaChain ? new Map() : null,
              f = new u.Mainstay(n, i, o),
              h = r._ids._schemaChain ? [{ schema: r }] : null,
              m = new c([], [], { mainstay: f, schemas: h }),
          ...
          (u.tracer = function (e, t) {
            return e.$_root._tracer
              ...
              : t.debug
              ? (s(e.$_root.trace, "Debug mode not supported"),
          ...
          (t.validate = function (e, t, r, s) {
            let n =
              arguments.length > 4 && void 0 !== arguments[4]
                ...
                : {};
            if (
              (t.$_terms.whens && (t = t._generate(e, r, s).schema),
              t._preferences && (s = u.prefs(t, s)),
              t._cache && s.cache)
            ) {
              const s = t._cache.get(e);
              if ((r.mainstay.tracer.debug(r, "validate", "cached", !!s), s))
                return s;
            }
            const a = (n, a, i) => t.$_createError(n, e, a, i || r, s),
              i = {
                ...
                message: (n, a) =>
                  t.$_createError("custom", e, a, r, s, { messages: n }),
              };
            ...
            if (l.prepare && void 0 !== e && s.convert) {
              ...
              if (t) {
                if (
                  (r.mainstay.tracer.value(r, "prepare", e, t.value), t.errors)
                )
            ...
            if (
              ...
              if (t) {
                if (
                  (r.mainstay.tracer.value(r, "coerced", e, t.value), t.errors)
                )
                  return u.finalize(t.value, [].concat(t.errors), i);
                e = t.value;
              }
            ...
            c &&
              c.$_match(u.trim(e, t), r.nest(c), o.defaults) &&
              (r.mainstay.tracer.value(r, "empty", e, void 0), (e = void 0));
            const f =
              n.presence ||
              t._flags.presence ||
              (t._flags._endedSwitch ? null : s.presence);
            if (void 0 === e) {
            ...
            if (t._valids) {
              ...
              if (n)
                return (
                  s.convert &&
                    (r.mainstay.tracer.value(r, "valids", e, n.value),
                    (e = n.value)),
                  r.mainstay.tracer.filter(t, r, "valid", n),
                  u.finalize(e, null, i)
                );
              if (t._flags.only) {
                const n = t.$_createError(
                  "any.only",
                  e,
            ...
            if (l.validate) {
              ...
              if (
                ...
                if (!Array.isArray(t.errors))
                  return h.push(t.errors), u.finalize(e, h, i);
                if (t.errors.length)
                  return h.push(...t.errors), u.finalize(e, h, i);
              }
            }
          ...
          (u.rules = function (e, t, r) {
            ...
            for (const i of s._rules) {
              ...
              if (h.errors) {
                if (
                  (n.mainstay.tracer.log(s, n, "rule", i.name, "error"), i.warn)
                ) {
                ...
                n.mainstay.tracer.log(s, n, "rule", i.name, "pass"),
                  n.mainstay.tracer.value(n, "rule", e, h.value, i.name),
                  (e = h.value);
            }
          ...
          (u.finalize = function (e, t, r) {
            ...
            if (t.length) {
              ...
              void 0 !== s &&
                (a.mainstay.tracer.value(a, "failover", e, s),
                (e = s),
                (t = []));
            }
            ...
            if (n._flags.cast && void 0 !== e) {
              ...
              if (t.from(e)) {
                const s = t.to(e, r);
                a.mainstay.tracer.value(a, "cast", e, s, n._flags.cast),
                  (e = s);
              }
            }
            ...
            const o = { value: e, errors: t.length ? t : null };
            return (
              n._flags.result &&
                ((o.value = "strip" === n._flags.result ? void 0 : r.original),
                a.mainstay.tracer.value(a, n._flags.result, e, o.value),
                a.shadow(e, n._flags.result)),
              n._cache &&
                !1 !== i.cache &&
                !n._refs.length &&
                n._cache.set(r.original, o),
              void 0 === e ||
                o.errors ||
                void 0 === n._flags.artifact ||
                ((a.mainstay.artifacts = a.mainstay.artifacts || new Map()),
                a.mainstay.artifacts.has(n._flags.artifact) ||
                  a.mainstay.artifacts.set(n._flags.artifact, []),
                a.mainstay.artifacts.get(n._flags.artifact).push(a.path)),
              o
            );
          }),
          ...
          (u.default = function (e, t, r, s) {
            const { schema: a, state: i, prefs: l } = s,
              c = a._flags[e];
            ...
            if ("function" == typeof c) {
              ...
              try {
                ...
                return void r.push(
                  a.$_createError(`any.${e}`, null, { error: t }, i, l)
                );
              }
            }
        ...
        (e.exports = i.Values =
          class {
            ...
            get(e, t, r, s) {
              ...
              if (t)
                for (const a of this._refs) {
                  const i = a.resolve(e, t, r, null, { in: !0 });
                  if (void 0 === i) continue;
                  const o =
                    a.in && "object" == typeof i
                      ? Array.isArray(i)
                        ? i
                        : Object.keys(i)
                      : [i];
                    ...
                    if (typeof t == typeof e)
                      if (s && e && "string" == typeof e) {
                        if (t.toLowerCase() === e.toLowerCase())
                          return { value: t, ref: a };
                      } else if (n(t, e)) return { value: t, ref: a };
                }
              return !1;
            }
            override() {
          ...
          (i.Values.prototype[a.symbols.values] = !0),
      ...
      978: (e, t, r) => {
        ...
        (e.exports = function (e, t) {
          ...
          if (
            ...
            s("object" == typeof r, "Invalid options: must be an object"),
            !t)
          )
            return null;
          ...
          return a(i, t, { nullOverride: l, mergeArrays: !1 });
        }),
          (o.applyToDefaultsWithShallow = function (e, t, r) {
            ...
            return a(f, t, { nullOverride: h, mergeArrays: !1 });
          }),
      ...
      8571: (e, t, r) => {
        ...
        const s = r(9621),
          n = r(4277),
          a = r(7043),
          i = { needsProtoHack: new Set([n.set, n.map, n.weakSet, n.weakMap]) };
        (e.exports = i.clone =
          function (e) {
            let t =
                arguments.length > 1 && void 0 !== arguments[1]
            ...
            if ((o && o.set(e, c), l === n.set))
              for (const r of e) c.add(s(r, t, o));
        ...
        (e.exports = function (e, t, r) {
          ...
          (n.isDeepEqualObj = function (e, t, r, a, i) {
            ...
            if (e === s.array) {
              ...
              for (const e of t)
                for (const t of r) if (o(e, t, a, i)) return !0;
            } else if (e === s.set) {
            ...
            let p = 0;
            for (const e of d)
              if (a.skip && a.skip.includes(e)) void 0 === r[e] && ++p;
              else {
                if (!c(r, e)) return !1;
                if (!o(t[e], r[e], a, i)) return !1;
              }
      ...
      1687: (e, t, r) => {
        ...
        e.exports = i.merge = function (e, t, r) {
          ...
          if (
            ...
            s(Array.isArray(e), "Cannot merge array onto an object"),
              r.mergeArrays || (e.length = 0);
            for (let s = 0; s < t.length; ++s)
              e.push(n(t[s], { symbols: r.symbols }));
            return e;
          }
          const o = a.keys(t, r);
          for (let s = 0; s < o.length; ++s) {
            ...
            if (l && "object" == typeof l) {
              ...
              !e[a] ||
              "object" != typeof e[a] ||
              Array.isArray(e[a]) !== Array.isArray(l) ||
              l instanceof Date ||
              l instanceof RegExp
                ? (e[a] = n(l, { symbols: r.symbols }))
                : i.merge(e[a], l, r);
        ...
        (t.Sorter = class {
          ...
          add(e, t) {
            const r = [].concat((t = t || {}).before || []),
              ...
              a = t.group || "?",
              i = t.sort || 0;
            s(!r.includes(a), `Item cannot come before itself: ${a}`),
              s(!r.includes("?"), "Item cannot come before unassociated items"),
              s(!n.includes(a), `Item cannot come after itself: ${a}`),
              s(!n.includes("?"), "Item cannot come after unassociated items"),
              Array.isArray(e) || (e = [e]);
            for (const t of e) {
              const e = {
          ...
          _sort() {
            ...
            for (const s in t)
              if (r[s]) for (const n of r[s]) e[n].push(...t[s]);
            const s = {};
            for (const t in e) {
              const r = e[t];
      ...
      5380: (e, t, r) => {
        ...
        (t.analyze = function (e) {
          ...
          if (t.maxDomainSegments && s.length > t.maxDomainSegments)
            return n.code("DOMAIN_SEGMENTS_COUNT_MAX");
          const i = t.tlds;
          if (i) {
            const e = s[s.length - 1].toLowerCase();
            if ((i.deny && i.deny.has(e)) || (i.allow && !i.allow.has(e)))
          ...
          for (let e = 0; e < s.length; ++e) {
            ...
            if (e < s.length - 1) {
              if (!a.domainSegmentRx.test(t))
                return n.code("DOMAIN_INVALID_CHARS");
            } else if (!a.tldSegmentRx.test(t))
      ...
      9959: (e, t, r) => {
        ...
        t.regex = function () {
          ...
          const a = `(?:${r
              ...
              .join("|")})`,
            i = new RegExp(`^${a}$`);
          return { cidr: t, versions: r, regex: i, raw: a };
        };
      },
      5752: (e, t, r) => {
        "use strict";
      ...
      1447: (e, t) => {
        ...
        (t.Parser = class {
          ...
          _parse(e) {
            ...
            const o = (e) => {
              ...
              if (i || n || e) {
                ...
                if (")" === e) {
                  ...
                  s.push({ type: "segment", value: e });
                } else if (i) {
                  if ("]" === i)
                    return (
                      s.push({ type: "reference", value: n }), void (n = "")
                    );
                  s.push({ type: "literal", value: n });
                } else if (r.operatorCharacters.includes(n))
                  o &&
                  "operator" === o.type &&
                  r.operators.includes(o.value + n)
                    ? (o.value += n)
                    : s.push({ type: "operator", value: n });
            ...
            1 === s.length &&
              ["reference", "literal", "constant"].includes(s[0].type) &&
              (this.single = {
          ...
          _subFormula(e, s) {
            ...
            if (e) {
              ...
              const o = () => {
                if (!t)
                  throw new Error(
                    `Formula contains function ${s} with invalid arguments ${e}`
                  );
                a.push(t), (t = "");
              };
              for (let s = 0; s < e.length; ++s) {
            ...
            return (
              (a = a.map((e) => new t.Parser(e, this.settings))),
              function (e) {
                const t = [];
          ...
          (r.calculate = function (e, t, s) {
            ...
            if ("string" == typeof t || "string" == typeof s) {
              if ("+" === e)
                return (t = r.exists(t) ? t : "") + (r.exists(s) ? s : "");
            } else
              switch (e) {
                case "^":
                  return Math.pow(t, s);
